...
<nav class=" px-6 py-3.5 border-b border-gray-300 mb-8 main">
  <div class="container max-w-320 mx-auto flex items-center justify-between">
    <a href="/" class="mr-8 py-1.5">
      <img src="/logo-denhaag.jpg" alt="" width="160" />
    </a>
    <div class="md:hidden">
      <Hamburger
    ...
    {#if menuIsOpen}
      <ul id="nav" class="menu" transition:fly={{ y: -15 }}>
        ...
        <li><a href="/faqs" onclick={resetOpenState}>Veelgestelde vragen</a></li>
        <li>
          <a
            href="."
            onclick={(event) => {
...
<div class="px-6">
  <div class="container max-w-320 mx-auto">
    <div class="mb-12 bg-yellow-100 text-yellow-800 px-6 sm:px-8 py-4 sm:py-5">
      ...
      <a href="//openstate.eu/nl" target="_blank" class="font-bold">Open State Foundation</a>.
    </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-center">
      ...
      <div class="text-gray-500 text-sm">
        <p>
          ...
          <a href="//openstate.eu/nl" class="text-gray-700 font-bold" target="_blank">
